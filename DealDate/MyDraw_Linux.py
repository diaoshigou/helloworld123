...
def Free_MEM(path,files,Date,Data,C):
    with open(path + "\\" + "MemAvailable.log",encoding="utf-8") as f:
        data = f.read()
        # C.append(D)
        j = 0
        for i in data.split("\n"):
    ...
    # plt.legend(labelspacing=5000)
    plt.xticks(range(1,1996,100))
    plt.ylabel("KB",fontsize=12,rotation=0,labelpad=100)
    plt.show()
...
path = r"E:\Moredian\tools\stability\2023-09-25\W3XPRO_460115230829KN0012\test"
